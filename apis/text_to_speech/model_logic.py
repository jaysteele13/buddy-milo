...
def chunk_text(text, max_tokens=510):
    ...
    for sentence in sentences:
        ...
        phonemes, _ = g2p(tentative)
        token_count = len(phonemes_to_tokens(insert_pauses(phonemes, pause_token=" "), vocab))
...
def text2speech(text):
    ...
    phonemes, _ = g2p(text)
    print(phonemes)
    phoneme_str = insert_pauses(phonemes, pause_token=" ")

    tokens = phonemes_to_tokens(phoneme_str, vocab)
